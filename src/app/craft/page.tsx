...
const FRAGMENT_RECIPES = [
  { id: 1, result: 'common', cost: { common: 4 }, reward: 3, name: '普通NFT', tier: 1 },
  { id: 2, result: 'rare', cost: { rare: 5 }, reward: 7, name: '稀有NFT', tier: 2 },
  { id: 3, result: 'epic', cost: { epic: 6 }, reward: 9, name: '史诗NFT', tier: 3 },
];
